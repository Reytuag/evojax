...
# Same as Cartpole.py but return as obs for the agent the last reward and last action
...
class CartPoleSwingUp(VectorizedTask):
    ...
    def __init__(self,
        ...
        def reset_fn(key):
            ...
            return State(state=state, obs=jnp.concatenate([get_obs(state),jnp.zeros((1,)),jnp.zeros((1,))]),
